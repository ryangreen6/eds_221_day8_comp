...
ggplot(data=wicked_pge, aes(x=Calendar_Year, y=Emissions_mtCO2e)) + 
  geom_jitter(aes(color=Calendar_Year)) +
  scale_color_gradient(low="orange", high="red") +
  labs(y= "Carbon Emissions\n(mt)", 
       x="Year", 
       title="CO2 Emissions Generated by PG&E") +
...
```{r}
ggplot(data=wicked_pge, aes(group=Sector_Detail2, x=Sector_Detail2, y=Emissions_mtCO2e)) +
  geom_boxplot()
